...
const pipelineStages = [
  ...
  { key: "ai_prompt_ready", label: "Prompt pronto", color: "bg-purple-500/10 text-purple-400 border-purple-500/20" },
  { key: "ai_site_generated", label: "Site gerado", color: "bg-purple-500/10 text-purple-400 border-purple-500/20" },
